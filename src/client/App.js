...
class App extends Component {
  ...
  handleChange(e) {
    const { al_nombre, value } = e.target;
    this.setState({
      [al_nombre]: value
    });
  }
        ...
        <nav className="red darken-4">
          <div className="container">
            <div className="nav-wrapper">
              ...
              <img src="logo.ico" align="left"></img>
              <a href="#" className="brand-logo" img="logo.ico">ETN 35</a>
            </div>
          </div>
        </nav>
              ...
              <div className="card">
                <div className="card-content">
                  <form onSubmit={this.addNote}>
                    ...
                    <div className="row">
                      <div className="input-field col s12">
                      <textarea name="al_curso" onChange={this.handleChange} value={this.state.al_curso} cols="30" rows="10" placeholder="curso del alumno" className="materialize-textarea"></textarea>
                      ...
                      <textarea name="c2" onChange={this.handleChange} value={this.state.c2} cols="30" rows="10" placeholder="nota del segundo cuatrimestre" className="materialize-textarea"></textarea>
